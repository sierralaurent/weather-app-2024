  ...
  return (
    <main className={`flex min-h-screen flex-col items-center text-black gap-20 p-3`}>
      ...
      <div className={'flex flex-col gap-10 rounded-lg border-black border-8 p-5 bg-slate-500 items-center'}>
        ...
        />
        <button onClick={fetchCurrentWeather} className={'btn btn-outline btn-secondary hover:scale-110 transition-transform'}>Search Current Weather</button>
        ...
        <Link href='/forecast'><button className="btn btn-outline btn-secondary hover:scale-110 transition-transform">See 5 day forecast</button></Link>
      </div>
      <footer>
