  ...
  return (
    ...
    <div className='flex flex-col gap-3 items-center text-white'>
      ...
      <div className={'flex flex-col gap-10  p-5 items-center'}>
        ...
        {searched && data && (
          <div>
          <p className='text-white text-2xl p-3 pb-6'>Current Weather for {city}</p>
          <div className='flex flex-col items-center rounded-lg bg-slate-300 p-10 '>
            <Image
            className='m-3 hover:scale-110 transition-transform'
      ...
      <Link href='/forecast'>
          <button className="mb-20 btn btn-outline btn-secondary hover:scale-110 transition-transform">See 5 day forecast</button>
        </Link>
    </main>
    <Footer />
