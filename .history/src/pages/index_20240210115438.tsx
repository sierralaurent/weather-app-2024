...
export default function Home() {
  ...
  const weatherImages: { [key: string]: string } = {
    ...
    Clouds: 'https://img.freepik.com/free-photo/black-rain-abstract-dark-power_1127-2380.jpg'// Add more weather conditions and corresponding image URLs as needed
  };
      ...
      <div className={'flex flex-col gap-10 rounded-lg border-black border-8 p-5 bg-slate-500 items-center'}>
        ...
        {searched && data && (
          <div className='flex flex-col items-center rounded-lg bg-slate-300 p-3 '>
            ...
            <img src={weatherImages[data.weather[0].main]} alt={data.weather[0].main} className="w-20 h-20" /> {/* Display weather image */}
