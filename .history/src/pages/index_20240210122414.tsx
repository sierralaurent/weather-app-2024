      ...
      <div className={'flex flex-col gap-10  p-5 pt-40 items-center'}>
        ...
        {searched && data && (
          <div className='flex flex-col items-center rounded-lg bg-slate-300 p-10 '>
            <h2 className='text-3xl font-bold'>Weather for {city}</h2>
            <Image
            ...
            <p className='text-xl'>Temp: {data.main.temp} °C</p>
            <p className='text-xl'>Wind speed: {data.wind.speed} meter/sec</p>
            <p className='text-xl'>Last Updated: {new Date(data.dt * 1000).toLocaleTimeString()}</p>
          </div>
        )}
        <Link href='/forecast'>
