    ...
    return(
        ...
        <footer className="footer footer-center p-10 bg-accent text-primary-content">
            <aside>
                ...
                <div>
                    <p className="font-bold text-xl p-2">DAS wetter Ltd.</p>
                    <p className='font-bold'>The Best German Weather Site Since 1992.</p>
                    <p>Die beste deutsche Wetterseite seit 1992.</p>
                </div> 
                <div>
